...
def validate():
    ...
    if (OUT/'discovery-scan.json').exists():
        ...
        if (OUT/'eternalstarlight-r2h2b-status-control.json').exists():
            from validate_eternalstarlight_status_control import validate_status_control
            assert validate_status_control()['status']=='PASS'
        if (OUT/'eternalstarlight-r2h3a-energy.json').exists():
            from validate_eternalstarlight_energy import validate_energy
            assert validate_energy()['status']=='PASS'
        if (OUT/'eternalstarlight-r2h3b-golems.json').exists():
            from validate_eternalstarlight_golems import validate_golems
            assert validate_golems()['status']=='PASS'
        if (OUT/'eternalstarlight-r2h3c-lunar.json').exists():
            from validate_eternalstarlight_lunar import validate_lunar
            assert validate_lunar()['status']=='PASS'
        ...
        if (OUT/'eternalstarlight-r2h4a-sonar-meteor-seeds.json').exists():
            from validate_eternalstarlight_sonar_meteor_seeds import validate_sonar_meteor_seeds
            assert validate_sonar_meteor_seeds()['status']=='PASS'
        if (OUT/'eternalstarlight-r2h4b-ether-blade-wilt.json').exists():
            from validate_eternalstarlight_ether_blade_wilt import validate_ether_blade_wilt
            assert validate_ether_blade_wilt()['status']=='PASS'
        ...
        if (OUT/'eternalstarlight-r2h5c-armor-resources.json').exists():
            from validate_eternalstarlight_armor_resources import validate_armor_resources
            assert validate_armor_resources()['status']=='PASS'
        if (OUT/'eternalstarlight-r2h6-crests-spells.json').exists():
            from validate_eternalstarlight_crests import validate_crests
            assert validate_crests()['status']=='PASS'
        ...
        if (OUT/'bossesrise-r2i2b-shared-combat.json').exists():
            from validate_bossesrise_shared import validate_shared
            assert validate_shared()['status']=='PASS'
        ...
        if (OUT/'bossesrise-r2i4-infernal-dragon.json').exists():
            from validate_bossesrise_dragon import validate_dragon
            assert validate_dragon()['status']=='PASS'
        ...
        if (OUT/'bossesrise-r2i7a-kraken-defense.json').exists():
            from validate_bossesrise_kraken_defense import validate_kraken_defense
            assert validate_kraken_defense()['status']=='PASS'
        if (OUT/'bossesrise-r2i7b-kraken-offense.json').exists():
            from validate_bossesrise_kraken_offense import validate_kraken_offense
            assert validate_kraken_offense()['status']=='PASS'
        ...
        if (OUT/'bossesrise-r2i8c-equipment.json').exists():
            from validate_bossesrise_equipment import validate_equipment
            assert validate_equipment()['status']=='PASS'
        if (OUT/'bossesrise-r2i9a-closure.json').exists():
            from validate_bossesrise_closure import validate_closure as validate_br_closure
            assert validate_br_closure()['status']=='PASS'
        ...
        if (OUT/'cataclysm-r2k3a-guardian-admission.json').exists():
            from validate_cataclysm_guardian_admission import validate_guardian_admission
            assert validate_guardian_admission()['status']=='PASS'
