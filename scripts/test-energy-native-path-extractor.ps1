param([string]$EvidencePath='docs/benchmarks/phase6-energy-steal-physical-prerequisite/es2-runtime.jsonl',[string]$OutputPath)
$ErrorActionPreference='Stop';$extractor=Join-Path $PSScriptRoot 'extract-phase6-energy-native-path.ps1'
...
$report=[ordered]@{schema='tno.phase6.energy_native_path.extractor_tests.v1';checkpoint='ES2';status='PASS';negative_tests=$results.Count;results=$results}
