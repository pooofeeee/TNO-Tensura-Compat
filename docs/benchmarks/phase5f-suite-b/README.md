...
scripts/extract-phase5f-suite-b.ps1 `
  ...
  -ExpectedFamily <MAGIC_WEAPON|HOLY_WEAPON|SOUL_EATER|ELEMENTAL_SLOTTING|ENERGY_STEAL|SEVERANCE> `
...
Carrion admitted all 540 combined physical/projectile arrow events, but L2
reduced or canceled every post-L2 amount to zero before native wound storage.
All 54 cases therefore remained at `0.00 Native -> 0.00 S7`. Tank and
Regenerate were present in every legal profile; Regenerate recorded no healing.
